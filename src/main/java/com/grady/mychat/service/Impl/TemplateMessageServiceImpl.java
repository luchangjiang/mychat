...
public class TemplateMessageServiceImpl implements TemplateMessageService {
    public RestResponse setIndustry(int id1, int id2){
        ...
        String uri = WeChatUtil.replaceAccessToken(WeChatConstants.SET_INDUSTRY_URL);
    ...
    public RestResponse getIndustry(){
        String uri = WeChatUtil.replaceAccessToken(WeChatConstants.GET_INDUSTRY_URL);
    ...
    public RestResponse getAllPrivateTemplates(){
        String uri = WeChatUtil.replaceAccessToken(WeChatConstants.GET_ALL_PRIVATE_TEMPLATE);
    ...
    public RestResponse getTemplateById(String templateId){
        String uri = WeChatUtil.replaceAccessToken(WeChatConstants.POST_TEMPLATE_ID_ADDR);
    ...
    public RestResponse delTemplateById(String templateId){
        String uri = WeChatUtil.replaceAccessToken(WeChatConstants.DEL_PRIVATE_TEMPLATE);
    ...
    public RestResponse sendTemplateMessage(String message){
        String uri = WeChatUtil.replaceAccessToken(WeChatConstants.SEND_TEMPLATE_MESSAGE);
